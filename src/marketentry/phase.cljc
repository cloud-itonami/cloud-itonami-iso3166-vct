(ns marketentry.phase
  "Phase 0->3 staged rollout for the Saint Vincent and the Grenadines
  (VCT) market-entry compliance actor.
  ...
  real portal package and submitting a real Central Procurement Board
  portal registration are the two real-world acts this actor
  performs; both are always a human market-entry operator's call.
